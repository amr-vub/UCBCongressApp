...
public class VotingService implements IVotingService {
	...
	public int getVoteAverage(VotingSession votingSession)
	{
		...
		{			
			...
			for(VoteChoices voteChoice : vote.getVote_Choice())
			{
				average += voteChoice.getVoteValue();
				voteCount++;
			}
