 ...
 *
 */
public class SLoginModule implements LoginModule {
	...
	public void setUsername(Integer uniqueID, String username) {
		this.username = username;
		
		//TODO: Store the username in the DB
	}

	public void setPassword(Integer uniqueID, char[] password) {
		this.password = password;
		
		//TODO: Store the password in the DB
	}
	...
	public boolean login() throws LoginException {
		...
		if (debug) {
			...
			System.out.println("\t\t[SLoginModule] "
					+ "user entered user name: " + username);
			// System.out.print("\t\t[SampleLoginModule] " +
			System.out.print("\t\t[SLoginModule] " + "user entered password: ");
		...
		//TODO: Fetch the password from the DB
		//TODO: Check the password matching
	}
	...
	public boolean commit() throws LoginException {
		if (succeeded == false) {
			...
			userPrincipal = new SPrincipal(username);
