...
public class RegisteredUserSurvey extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gridView = (GridView) findViewById(R.id.register_gridView1);
		...
		nextButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(RegisteredUserSurvey.this,
						HomeActivity.class);
