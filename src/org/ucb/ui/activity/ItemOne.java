...
public class ItemOne extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		PagerTitleStrip tabs = (PagerTitleStrip) view.findViewById(R.id.agenda_pager_title_strip);
		ViewPager pager = (ViewPager) view.findViewById(R.id.agenda_view_pager);
